...
{
public:
    static void select(Node::Nodes& nodes, const Node& start, String xpath);
...
private:
     ...
     * Match nodes
     */
    static void matchNode(const Node& thisNode, Node::Nodes& nodes, const std::vector<XPathElement>& pathElements,
                          int pathPosition,
                          const String& starPointer);
