...
SocketEvents::SocketEvents(const String& name, const SocketEventCallback& eventsCallback, const chrono::milliseconds& timeout, SocketPool::TriggerMode triggerMode)
    : Thread(name)
