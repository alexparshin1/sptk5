...
TEST(SPTK_VariantStorage, Buffer)
{
    ...
    EXPECT_EQ(VariantStorage::Type::Buffer, variantStorage3.type());
...
TEST(SPTK_VariantStorage, String)
{
    ...
    EXPECT_EQ(VariantStorage::Type::String, variantStorage3.type());
...
TEST(SPTK_VariantStorage, DateTime)
{
    ...
    EXPECT_EQ(VariantStorage::Type::DateTime, variantStorage2.type());
...
TEST(SPTK_VariantStorage, MoneyData)
{
    ...
    const VariantStorage variantStorage3(std::move(variantStorage2));
    EXPECT_EQ(VariantStorage::Type::Money, variantStorage3.type());
    ...
    variantStorage4 = variantStorage;
    EXPECT_EQ(VariantStorage::Type::Money, variantStorage4.type());
...
TEST(SPTK_VariantStorage, CharPointer)
{
    ...
    const VariantStorage variantStorage3(std::move(variantStorage2));
    EXPECT_EQ(VariantStorage::Type::CharPointer, variantStorage3.type());
...
TEST(SPTK_VariantStorage, BytePointer)
{
    ...
    const VariantStorage variantStorage3(std::move(variantStorage2));
    EXPECT_EQ(VariantStorage::Type::BytePointer, variantStorage3.type());
