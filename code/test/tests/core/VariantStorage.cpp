...
TEST(SPTK_VariantStorage, null)
{
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_NONE, variantStorage.type());
...
TEST(SPTK_VariantStorage, bool)
{
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_BOOL, variantStorage.type());
...
TEST(SPTK_VariantStorage, integer)
{
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_INT, variantStorage1.type());
    ...
    variantStorage1 = 0.1;
    variantStorage1 = 2L;
    EXPECT_EQ(VariantStorage::Type::VAR_INT64, variantStorage1.type());
    EXPECT_EQ(2, (int) variantStorage1);
    EXPECT_FALSE(variantStorage1.isNull());

    VariantStorage variantStorage2((int64_t) 3);
    EXPECT_EQ(VariantStorage::Type::VAR_INT64, variantStorage2.type());
...
TEST(SPTK_VariantStorage, double)
{
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_FLOAT, variantStorage.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_FLOAT, variantStorage2.type());
...
TEST(SPTK_VariantStorage, Buffer)
{
    ...
    Buffer testBuffer2("Test buffer 2");

    VariantStorage variantStorage(testBuffer);
    EXPECT_EQ(VariantStorage::Type::VAR_BUFFER, variantStorage.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_BUFFER, variantStorage2.type());
    ...
    const VariantStorage variantStorage3(variantStorage2);
    EXPECT_EQ(VariantStorage::Type::VAR_BUFFER, variantStorage3.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_BUFFER, variantStorage4.type());
...
TEST(SPTK_VariantStorage, String)
{
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_STRING, variantStorage.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_STRING, variantStorage2.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_STRING, variantStorage3.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_STRING, variantStorage4.type());
...
TEST(SPTK_VariantStorage, DateTime)
{
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_DATE_TIME, variantStorage.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_DATE_TIME, variantStorage2.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_DATE_TIME, variantStorage3.type());
...
TEST(SPTK_VariantStorage, MoneyData)
{
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_MONEY, variantStorage.type());
    ...
    VariantStorage variantStorage2(variantStorage);
    EXPECT_EQ(VariantStorage::Type::VAR_MONEY, variantStorage2.type());
    EXPECT_DOUBLE_EQ((double) testMoneyData2, (double) ((const MoneyData&) variantStorage2));

    const VariantStorage variantStorage3(std::move(variantStorage2));
    EXPECT_EQ(VariantStorage::Type::VAR_MONEY, variantStorage3.type());
    ...
    variantStorage4 = variantStorage;
    EXPECT_EQ(VariantStorage::Type::VAR_MONEY, variantStorage4.type());
...
TEST(SPTK_VariantStorage, CharPointer)
{
    ...
    const char* testText2 = "Test text 2";

    VariantStorage variantStorage(testText);
    EXPECT_EQ(VariantStorage::Type::VAR_CHAR_POINTER, variantStorage.type());
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_CHAR_POINTER, variantStorage.type());
    EXPECT_STREQ(testText2, (const char*) variantStorage);

    VariantStorage variantStorage2(variantStorage);
    EXPECT_EQ(VariantStorage::Type::VAR_CHAR_POINTER, variantStorage2.type());
    EXPECT_STREQ(testText2, (const char*) variantStorage2);

    const VariantStorage variantStorage3(std::move(variantStorage2));
    EXPECT_EQ(VariantStorage::Type::VAR_CHAR_POINTER, variantStorage3.type());
    EXPECT_STREQ(testText2, (const char*) variantStorage3);
...
TEST(SPTK_VariantStorage, BytePointer)
{
    ...
    EXPECT_EQ(VariantStorage::Type::VAR_BYTE_POINTER, variantStorage.type());
    ...
    VariantStorage variantStorage2(variantStorage);
    EXPECT_EQ(VariantStorage::Type::VAR_BYTE_POINTER, variantStorage2.type());
    EXPECT_EQ(testBytes2.data(), (const uint8_t*) variantStorage2);

    const VariantStorage variantStorage3(std::move(variantStorage2));
    EXPECT_EQ(VariantStorage::Type::VAR_BYTE_POINTER, variantStorage3.type());
...
{
    VariantStorage variantStorage;
    VariantStorage variantStorage2("Test");
    variantStorage = std::move(variantStorage2);
    EXPECT_EQ(VariantStorage::Type::VAR_CHAR_POINTER, variantStorage.type());
    EXPECT_STREQ("Test", (const char*) variantStorage);
}
