...
int main(int argc, char** argv)
{
    ...
    CGroup g1("", 20, CLayoutAlign::BOTTOM);

    CGroup g2("Grid Parameters", 150, CLayoutAlign::LEFT);
    CCheckButton cb1("Row auto height", 10, CLayoutAlign::BOTTOM);
    cb1.callback(cb_cb, (void*) ROWS_AUTO_HEIGHT);
    CCheckButton cb2("Show grid", 10, CLayoutAlign::BOTTOM);
    cb2.callback(cb_cb, (void*) SHOW_GRID);
    showGridCheckButton = &cb2;
    CCheckButton cb3("Show stripes", 10, CLayoutAlign::BOTTOM);
    cb3.callback(cb_cb, (void*) SHOW_STRIPES);
    showStripesCheckButton = &cb3;
    g2.end();

    CButton b(SP_EXIT_BUTTON, CLayoutAlign::RIGHT);
    b.callback(exit_cb);
