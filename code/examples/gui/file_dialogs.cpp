...
int main(int argc, char* argv[])
{
    try
    {
        ...
        CButton b1(CButtonKind::OPEN_BUTTON, CLayoutAlign::TOP, "Open File Dialog");
        b1.callback(file_open_dialog_cb);

        CButton b2(CButtonKind::SAVE_BUTTON, CLayoutAlign::TOP, "Save File Dialog");
        b2.callback(file_save_dialog_cb);

        CButton b3(CButtonKind::BROWSE_BUTTON, CLayoutAlign::TOP, "Open Directory Dialog");
