    ...
    : CWindow(w, h, t)
{
    ...
    auto* grp = new CGroup("", 10, CLayoutAlign::BOTTOM);
...
void cursor_cb(Fl_Widget* w, void*)
{
    ...
    e->cursor_position->data(String("Row " + to_string(row) + ", Col " + to_string(col)));
    e->reLayout();
}
...
CWindow* new_view()
{
    ...
    w->editor = new CEditor(10, CLayoutAlign::CLIENT);
    ...
    auto* grp = new CGroup("", 20, CLayoutAlign::BOTTOM);
    grp->layoutSpacing(1);
    w->cursor_position = new CBox("", 150, CLayoutAlign::RIGHT);
