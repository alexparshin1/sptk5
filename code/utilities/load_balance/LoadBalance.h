    ...
    : public Thread
{
    ...
    static void sourceEventCallback(const std::weak_ptr<Channel>& channelPtr, SocketEventType eventType);

    static void destinationEventCallback(const std::weak_ptr<Channel>& channelPtr, SocketEventType eventType);
