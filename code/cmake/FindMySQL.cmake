...
IF (MariaDB_INCLUDE_DIR)
    SET (MARIADB_FLAG 1)
    IF (NOT WIN32)
        EXEC_PROGRAM (grep ARGS my_bool "${MariaDB_INCLUDE_DIR}/mysql.h" OUTPUT_VARIABLE MySQL_has_my_bool_match)
    ENDIF ()
ELSE ()
    SET(MARIADB_FLAG 0)
    IF (NOT WIN32)
        EXEC_PROGRAM (grep ARGS my_bool "${MySQL_INCLUDE_DIR}/mysql.h" OUTPUT_VARIABLE MySQL_has_my_bool_match)
    ENDIF ()
ENDIF ()
