/***************************************************************************
                         ...
                         CThreadManager.cpp  -  description
                             -------------------
...
#include <sptk5/threads/CThreadManager.h>

using namespace std;
using namespace sptk;

CThreadManager::CThreadManager(uint32_t threadLimit, uint32_t threadIdleSeconds) :
...
CWorkerThread* CThreadManager::createThread()
{
...
void CThreadManager::execute(CRunable* task)
{
    SYNCHRONIZED_CODE;
    if (m_shutdown)
...
void CThreadManager::threadEvent(CThread* thread, CThreadEvent::Type eventType)
{
    SYNCHRONIZED_CODE;
    switch (eventType) {
