...
void AsyncTcpSocket::_open(const Host& host, BaseSocket::CSocketOpenMode openMode, bool blockingMode, chrono::milliseconds timeout)
{
    TCPSocket::_open(host, openMode, blockingMode, timeout);
}

void AsyncTcpSocket::_open(const struct sockaddr_in& address, BaseSocket::CSocketOpenMode openMode, bool blockingMode, chrono::milliseconds timeout)
{
    TCPSocket::_open(address, openMode, blockingMode, timeout);
}
