...
void CBaseButton::image(CButtonKind buttonKind,CIconSize iconSize,const char *label) {
   ...
   const char *l;
   switch (buttonKind) {
      default:                 name = 0;          l = 0;         break;
      case SP_ADD_BUTTON:      name = "add";      l = "Add";     break;
      case SP_DELETE_BUTTON:   name = "delete";   l = "Delete";  break;
      case SP_EDIT_BUTTON:     name = "edit";     l = "Edit";    break;
      case SP_BROWSE_BUTTON:   name = "browse";   l = "Browse";  break;
      case SP_CALENDAR_BUTTON: name = "calendar"; l = "Date";    break;
      case SP_REFRESH_BUTTON:  name = "refresh";  l = "Refresh"; break;
      case SP_CANCEL_BUTTON:   name = "cancel";   l = "Cancel";  break;
      case SP_HELP_BUTTON:     name = "help";     l = "Help";    break;
      case SP_NO_BUTTON:       name = "no";       l = "No";      break;
      case SP_OK_BUTTON:       name = "ok";       l = "Ok";      break;
      case SP_OPEN_BUTTON:     name = "open";     l = "Open";    break;
      case SP_PRINT_BUTTON:    name = "print";    l = "Print";   break;
      case SP_SAVE_BUTTON:     name = "save";     l = "Save";    break;
      case SP_COPY_BUTTON:     name = "copy";     l = "Insert";  break;
      case SP_LEFT_BUTTON:     name = "left";     l = "Left";    break;
      case SP_NEW_BUTTON:      name = "new";      l = "New";     break;
      case SP_NEXT_BUTTON:     name = "next";     l = "Next";    break;
      case SP_PRINTER_BUTTON:  name = "printer";  l = "Printer"; break;
      case SP_PRIOR_BUTTON:    name = "prior";    l = "Prior";   break;
      case SP_RIGHT_BUTTON:    name = "right";    l = "Right";   break;
      case SP_SEARCH_BUTTON:   name = "search";   l = "Search";  break;
      case SP_SEND_BUTTON:     name = "send";     l = "Send";    break;
      case SP_STEPLEFT_BUTTON: name = "stepleft";  l = "Step Left";  break;
      case SP_STEPRIGHT_BUTTON:name = "stepright"; l = "Step Right"; break;
      case SP_VIEW_BUTTON:     name = "view";     l = "View";    break;
      case SP_HOME_BUTTON:     name = "home";     l = "Home";    break;
      case SP_EXEC_BUTTON:     name = "exec";     l = "Exec";    break;
      case SP_STOP_BUTTON:     name = "stop";     l = "Stop";    break;
      case SP_EXIT_BUTTON:     name = "exit";     l = "Exit";    break;
      case SP_SAVE_AS_BUTTON:  name = "saveas";   l = "Save As.."; break;
      case SP_CONFIGURE_BUTTON:name = "configure";l = "Settings"; break;
   }
   if (!label)
      label = l;
   m_image = 0;
...
CLayoutClient* CButton::creator(CXmlNode *node) {
    CButton* button = new CButton("",SP_ALIGN_TOP,THM_BUTTON_NORMAL);
    button->load(node);
    return button;
}

void CButton::load(const CXmlNode *node) {
    CLayoutClient::load(node,LXM_LAYOUT);
    string iconName = node->getAttribute("icon");
    string iconType = node->getAttribute("size","large");
    CIconSize iconSize;
    switch (iconType[0]) {
        case 'c': iconSize = IS_COMBO_ICON; break;
        case 's': iconSize = IS_SMALL_ICON; break;
        default:
        case 'l': iconSize = IS_LARGE_ICON; break;
    }
    if (!iconName.empty()) {
...
void CButton::save(CXmlNode *node) const {
