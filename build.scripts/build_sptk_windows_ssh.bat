...
#
# Despite the .bat, this runs on Linux: it is the caller, not the thing that builds. The name is
# kept because that is what it has always been called from here.
#
