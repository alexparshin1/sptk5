...
private:
    ...
    void scanDescendents(CXmlNodeVector& nodes,const std::vector<CXPathElement>& pathElements,int pathPosition,const std::string* starPointer);
    ...
    bool matchPathElement(const CXPathElement& pathElement,int nodePosition,const std::string* starPointer,bool& nameMatches,bool& positionMatches);
    ...
    /// @param pathPosition int, current path elements position
    /// @param starPointer const std::string*, the pointer to SST '*' string
    void matchNode(CXmlNodeVector& nodes,const std::vector<CXPathElement>& pathElements,int pathPosition,const std::string* starPointer);
...
protected:
    ...
    CXmlNamedItem(CXmlDoc& doc) : CXmlNode(doc) {}
