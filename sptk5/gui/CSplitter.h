...
class CSplitter : public CBox {
    ...
    bool            m_dragging;                /// The flag indicating the dragging state
    int             m_lastDragX;               /// Where did we grab the bar (x-coordinate) ?
    int             m_lastDragY;               /// Where did we grab the bar (y-coordinate) ?
protected:
