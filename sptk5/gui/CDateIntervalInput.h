...
class SP_EXPORT CDateIntervalInput : public CInput {
    ...
    CDateControl   *m_firstDateInput;   ///< First date input widget
    CDateControl   *m_secondDateInput;  ///< Second date input widget
    std::string     m_separator;            ///< Separator to display
    CPopupCalendar *m_calendarWindow;   ///< Pop-up calendar window
