...
class SP_EXPORT CInput_ : public Fl_Input, public CLayoutClient {
    ...
    int         m_maxLength;      ///< Maximum input length
    std::string m_mask;           ///< Full input mask
    std::string m_inputMask;      ///< Actual input mask
    std::string m_backgroundMask; ///< Background (static) characters in mask
