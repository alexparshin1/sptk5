...
enum CControlKind
{
    ...
    DCV_STRING=4,                ///< Control is a text input (single line)
    DCV_MEMO=8,                  ///< Control is a text input (multiple lines)
    DCV_INTEGER=0x10,            ///< Control is an integer value input
    DCV_FLOAT=0x20,              ///< Control is an integer value input
    DCV_DATE=0x40,               ///< Control is a date input
    DCV_TIME=0x80,               ///< Control is a time input
    DCV_DATETIME=0x100,          ///< Control is a date and time input
    DCV_DATEINTERVAL=0x200,      ///< Control is a date interval input
    DCV_COMBO=0x400,             ///< Control is a combobox
    DCV_INTVALUECOMBO=0x800,     ///< Control is a combobox with int key value
    DCV_LISTBOX=0x1000,          ///< Control is a listbox
    DCV_CHECKBUTTONS=0x2000,     ///< Control is a set of check buttons
    DCV_RADIOBUTTONS=0x4000,     ///< Control is a set of radio buttons
    DCV_PHONE=0x8000,            ///< Control is a phone number input
    DCV_TREEVIEW=0x10000,        ///< Control is a tree widget
    DCV_GROUP=0x20000,           ///< Control is a group
    DCV_SLIDER=0x40000,          ///< Control is a value slider
    DCV_PROGRESS=0x80000         ///< Control is a progress bar
};
...
enum FGENTRYFLAGS
{
    ...
    FGE_CFIELD=4,               ///< Is a custom field
    FGE_SINGLELINEENTRY=256,    ///< Is a single-line entry
    FGE_MULTILINEENTRY=512      ///< Is a multi-line entry
};
...
protected:
    ...
    bool              m_limited;     ///< Control has the defined min and max values
    uint32_t          m_labelWidth;  ///< Control label width (on the left)
    Fl_Color          m_labelColor;  ///< Control label color
    Fl_Color          m_textColor;   ///< Control text color
    Fl_Font           m_textFont;    ///< Control text font
    uchar             m_textSize;    ///< Control text font size
    std::string       m_fieldName;   ///< Field name for the universal data connection
    std::string       m_hint;        ///< The text of the hint
    Fl_Widget*        m_control;     ///< The main widget inside the control.
    int               m_tag;         ///< Control's special data tag
    /// @brief Control's special flags (a bit combination of FGENTRYFLAGS).
    /// @see FGENTRYFLAGS for details.
    uint32_t          m_controlFlags;
    Fl_Menu_Button   *m_menuButton;  ///< Control's menu button - to show right-mouse click menu
    CEventInfo        m_event;       ///< The last SPTK event inside this control.
    bool              m_hasFocus;    ///< Does the control have focus?
