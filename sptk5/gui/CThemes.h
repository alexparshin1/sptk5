    ...
    public CThemeScrollBar
{
    ...
    static std::string m_name;              ///< Theme name

    static Fl_Box_Draw_F *m_flatBox;        ///< Original flat box draw function
    static Fl_Box_Draw_F *m_thinUpBox;      ///< Original thin up box draw function
    static Fl_Box_Draw_F *m_upBox;          ///< Original up box draw function
    static Fl_Box_Draw_F *m_thinDownBox;    ///< Original thin down box draw function
    static Fl_Box_Draw_F *m_downBox;        ///< Original down box draw function

    static Fl_Box_Draw_F *m_thinUpFrame;    ///< Original thin up frame draw function
    static Fl_Box_Draw_F *m_upFrame;        ///< Original up frame draw function
    static Fl_Box_Draw_F *m_thinDownFrame;  ///< Original thin down frame draw function
    static Fl_Box_Draw_F *m_downFrame;      ///< Original down frame draw function

    static CFontsMap      m_fonts;          ///< Available fonts
    static CFrames        m_frames;         ///< Available frames
    static std::string    m_themeFolder;    ///< Path to the theme' folder
