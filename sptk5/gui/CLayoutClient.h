...
protected:
    ...
    int          m_lastPreferredW;  ///< The width as a result of the last call of preferredSize()
    int          m_lastPreferredH;  ///< The width as a result of the last call of preferredSize()

    Fl_Widget*   m_widget;          ///< Widget to manage
    std::string  m_name;            ///< Widget name (widget id)
    std::string  m_label;           ///< Widget caption storage
    CLayoutAlign m_layoutAlign;     ///< The layout align for the widget in CLayoutManager group
public:
    /// @brief Constructor
